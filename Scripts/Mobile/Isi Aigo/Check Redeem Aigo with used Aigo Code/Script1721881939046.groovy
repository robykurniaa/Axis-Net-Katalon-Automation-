...
Mobile.takeScreenshot('Axis Net Redeem Aigo - Robby')
...
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('redeem used aigo')
Mobile.delay(1)

'Tap Quick Menu Isi Aigo'
...
if (Mobile.verifyElementExist(popUpElement, 3, FailureHandling.OPTIONAL)) {
	...
	Mobile.pressBack()
	Mobile.delay(5)
	Mobile.setText(findTestObject('Mobile/Redeem Aigo/ObjFillAigoNumber'), GlobalVariable.UsedAigo, 5)
} else {
	Mobile.setText(findTestObject('Mobile/Redeem Aigo/ObjFillAigoNumber'), GlobalVariable.UsedAigo, 5)
}
...
def dialogMssg = findTestObject('Mobile/Redeem Aigo/ObjDialogMssg - Used Aigo')
Mobile.waitForElementPresent(dialogMssg, 5, FailureHandling.STOP_ON_FAILURE)
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('redeem used aigo')
Mobile.delay(5)
