...
Mobile.takeScreenshot('C://Axis Net Automation//ScreenShoot//Mobile//Login//TC 003//1.png')

'Tap Button Login'
Mobile.tap(findTestObject('Mobile/Login/Login Page/ObjBtnLoginPage - Start'), 0)

Mobile.takeScreenshot('C://Axis Net Automation//ScreenShoot//Mobile//Login//TC 003//2.png')

'Input Invalid MSISDN (Other Operator)'
Mobile.setText(findTestObject('Mobile/Login/Login Page/ObjLoginInputMSISDN'), GlobalVariable.AxisInvalidNumber, 0)

Mobile.hideKeyboard()

Mobile.takeScreenshot('C://Axis Net Automation//ScreenShoot//Mobile//Login//TC 003//3.png')

'Tap Button Login'
Mobile.tap(findTestObject('Mobile/Login/Login Page/ObjBtnLoginPage - Number'), 0)

'Get Text Warning Message'
Mobile.waitForElementPresent(findTestObject('Mobile/Login/WarningWrongOTP'), 0)

Mobile.takeScreenshot('C://Axis Net Automation//ScreenShoot//Mobile//Login//TC 003//4.png')
