...
Mobile.takeScreenshot('Axis Net Mystery Box - Robby')
'medallia handling'
...
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('sureprize - tap playground')
Mobile.delay(1)

'Tap Sureprize'
Mobile.tap(findTestObject('Mobile/Playground/Sureprize/Sureprize Page'), 5)

Mobile.delay(1)
Screenshot.takeDynamicScreenshot('sureprize - tap Sureprize')
Mobile.delay(1)

'Tap Lanjut'
Mobile.tap(findTestObject('Object Repository/Mobile/Playground/Sureprize/ObjBtnInformation - Lanjut'), 5)
Mobile.delay(5)
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('sureprize - tap Lanjut')
Mobile.delay(1)

'\'scroll down\''
//Mobile.scrollToText('CHAT')

'Claim Bonus'
Mobile.tap(findTestObject('Mobile/Playground/Sureprize/ClaimSureprize - Index 5 (Sosmed)'), 5)
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('sureprize - Claim Bonus')
Mobile.delay(1)

'verify success page'
//Mobile.waitForImagePresent(findTestObject('Mobile/Playground/Sureprize/GetTextSuccesClaim - Sureprize'), 0)

'btn oke - success page'
def successClaim = findTestObject('Mobile/Playground/Sureprize/BtnOke - Success Claim')
Mobile.waitForElementPresent(successClaim, 20, FailureHandling.OPTIONAL)
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('sureprize - success claim bonus')
Mobile.delay(1)
Mobile.tap(findTestObject('Mobile/Playground/Sureprize/BtnOke - Success Claim'), 0)
Mobile.delay(2)
