...
'Input MSISDN'
Mobile.setText(findTestObject('Mobile/Login/Login Page/ObjLoginInputMSISDN'), '083891411050', 0)
...
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('Mystery Box')
Mobile.delay(1)

'Tap Mystery Box'
Mobile.tap(findTestObject('Mobile/Playground/Mystery Box/MysteryBoxPage'), 0)
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('Mystery Box')
Mobile.delay(1)
...
'Tap Lanjut'
Mobile.tap(findTestObject('Mobile/Playground/Mystery Box/BtnLanjut - Mystery Box'), 0)
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('Mystery Box')
Mobile.delay(1)

'Tap Main Sekarang'
Mobile.tap(findTestObject('Mobile/Playground/Mystery Box/BtnNext - Main Sekarang'), 0)
Mobile.delay(1)
Screenshot.takeDynamicScreenshot('Mystery')
Mobile.delay(1)

'Claim Bonus'
Mobile.tap(findTestObject('Mobile/Playground/Mystery Box/ClaimMysteryBox'), 0)
Mobile.delay(5)
Screenshot.takeDynamicScreenshot('Mystery Box')
Mobile.delay(1)

'error handling'
def verifySuccessClaim = findTestObject('Mobile/Playground/Mystery Box/ObjBtnOk - success claim mystbox')

if (Mobile.verifyElementExist(verifySuccessClaim, 3,FailureHandling.OPTIONAL)) {
	// Element is present
	 Mobile.tap(findTestObject('Mobile/Playground/Mystery Box/ObjBtnOk - success claim mystbox'), 0)
	Mobile.comment('Element found and tapped')
} else {
	// Element is not present
	Mobile.delay(5)
