...
'Tap Buat Paket'
Mobile.tap(findTestObject('Object Repository/Mobile/Byop/ObjBtn - Coba Buat paket'), 5)

'Tap Lewati'
Mobile.tap(findTestObject('Object Repository/Mobile/Byop/ObjBtn - Lewati'), 5)
...
Mobile.scrollToText('Conference')

'tap pilih conference'
Mobile.tap(findTestObject('Object Repository/Mobile/Byop/ObjBtn - PILIH Conference'), 4)

'choose add on'
Mobile.tap(findTestObject('Object Repository/Mobile/Byop/ObjSelectAddon - Conference index 1'), 4)
