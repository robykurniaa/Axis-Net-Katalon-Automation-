...
// Check Readmission
WebUI.click(findTestObject('Web/Heroku App/Make Appointment/Page_CURA Healthcare Service/Check Readmission'))
...
String visitDate = '2024-10-01' // Change to your preferred format
...
String comment = 'This is an automated appointment booking test 2nd time	.'
